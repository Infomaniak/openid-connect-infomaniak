...
/**
 * OpenID_Connect_Infomaniak_Client_Wrapper class.
 *
 ...
 * @category Authentication
 */
class OpenID_Connect_Infomaniak_Client_Wrapper {
	 ...
	 *
	 * @param OpenID_Connect_Infomaniak_Client          $client   A plugin client object instance.
	 ...
	 */
	public function __construct( OpenID_Connect_Infomaniak_Client $client, OpenID_Connect_Infomaniak_Option_Settings $settings, OpenID_Connect_Infomaniak_Option_Logger $logger ) {
		$this->client = $client;
	 ...
	 *
	 * @param \OpenID_Connect_Infomaniak_Client          $client   The plugin client instance.
	 * @param \OpenID_Connect_Infomaniak_Option_Settings $settings The plugin settings instance.
	 * @param \OpenID_Connect_Infomaniak_Option_Logger   $logger   The plugin logger instance.
	 *
	 * @return \OpenID_Connect_Infomaniak_Client_Wrapper
	 */
	public static function register( OpenID_Connect_Infomaniak_Client $client, OpenID_Connect_Infomaniak_Option_Settings $settings, OpenID_Connect_Infomaniak_Option_Logger $logger ) {
	...
	public function get_authentication_url( $atts = array() ) {
		...
		$atts = shortcode_atts(
			...
			$atts,
			'infomaniak_connect_generic_auth_url'
		);
